...
break
case 4:x=6
return A.c(A.aZL(A.d("allwoDeviceCalendar",!0),d),$async$G5)
case 6:v=!1
x=1
break
case 5:x=s===B.mC?7:8
break
case 7:x=9
return A.c(F.azz(B.EY),$async$G5)
...
this.b=e},
ai0(d){return C.dO5(d)},
dO5(d){var x=0,w=A.j(y.v),v,u,t
var $async$ai0=A.e(function(e,f){if(e===1)return A.f(f,w)
while(true)switch(x){case 0:t={}
x=3
return A.c(A.bK(d,A.ai("calendarsPicker",0)),$async$ai0)
case 3:if(f!==!0){new A.ah(A.d("thereIsProblem",!0),B.k,B.l,B.n,d).L()
x=1
break}t.a=null
u=A.Q(d,!1)
x=4
return A.c(A.bB("assets/animations/success_animation.json.zip",d,B.I,$.cUx().Sn().J(0,new C.cPF(t),y.e),"",u,!0,!0,!0,!1,B.K).bc(),$async$ai0)
...
t.toString
x=5
return A.c(A.e0(d,!0,E.drz(t),1,u).em(),$async$ai0)
case 5:v=f
x=1
break
case 1:return A.h(v,w)}})
...
$S:2}
C.cHA.prototype={
$3(d,e,f){var x,w,v,u,t=null,s=A.cU(new A.ax(7,7)),r=A.q(d).ax.cx
r=A.fr(A.T(B.f.a8(178.5),r.gj(r)>>>16&255,r.gj(r)>>>8&255,r.gj(r)&255),1)
x=e==null
w=x?t:e.b
if(w==null)w=A.d("chooseCalendar",!0)
v=A.kv(t,!1,!1,!1,!1,!1,0.7,20)
if((x?t:e.f)==null)u=t
else u=x?t:e.f
...
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_457",e:"endPart",h:b})})($__dart_deferred_initializers__,"bD/dnw/lL/XVIcmw3T6fgJIl4/M=");