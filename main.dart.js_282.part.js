...
WD(d,e,f,g){var x=0,w=A.j(y.b),v,u,t,s,r
var $async$WD=A.e(function(h,i){if(h===1)return A.f(i,w)
while(true)switch(x){case 0:x=2
return A.c(A.bL(e,A.ai("statistcsPage",0)),$async$WD)
case 2:u=i
t=$.bp().a
s=y.g
r=A.cS(t.a,s)
...
Wm(d,e,f,g){var x=0,w=A.j(y.b),v,u,t,s,r
var $async$Wm=A.e(function(h,i){if(h===1)return A.f(i,w)
while(true)switch(x){case 0:x=2
return A.c(A.bL(e,A.ai("customersPage",0)),$async$Wm)
case 2:u=i
t=$.bp().a
s=y.g
r=A.cS(t.a,s)
