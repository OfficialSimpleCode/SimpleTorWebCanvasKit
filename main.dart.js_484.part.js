...
aYB(d,e){var x=0,w=A.j(y.y),v,u,t,s,r,q,p,o,n,m
var $async$aYB=A.e(function(f,g){if(f===1)return A.f(g,w)
...
s=new A.cN(C.bf,u)
r=new A.b2(null,y.o)
u=A.E(A.d("changeTreatmentMoney",!0),null,!1,!1,null,!1,!1,null,!1,!1,!1,1,null,!1,16,null,"")
q=$.aj()
...
m=A.d("update",!0)
x=3
return A.c(A.cX(C.ak,!1,1,!0,null,A.d("cancel",!0),null,n,d,C.N,20,!0,C.z,new B.cHl(d),new B.cHm(r,t,e,d,s),!1,m,null),$async$aYB)
case 3:v=g
x=1
break
case 1:return A.h(v,w)}})
return A.i($async$aYB,w)},
...
if(!(A.fV(v.ax,w)!=null&&v.x!=null))return new A.m(w,w,w,w)
if(this.c==null&&this.d==null)return new A.m(w,w,w,w)
v=A.q(d).ax
x=v.y
v=x==null?v.f:x
return A.c4(!1,v,w,D.rR,!0,!0,w,w,w,!0,new B.bJD(this,d),!1,w,w,w,w,w,A.d("paymentRequest",!0),w)}}
B.a90.prototype={
n(d){var x=null
...
v===$&&A.b()
v.toString
if(x.a===v.a&&x.b.a===v.b.a){new A.ag(A.d("priceNotChanged",!0),C.k,C.l,C.n,t.d).M()
return}u=A.qb(w)
u.e=s.a
u.cy=t.e.a.a
A.Q(t.d,!1).W(u)},
...
break
case 2:x=5
return A.c(A.Ww(g,f,new B.bJC(k),null,null,k.r),$async$$0)
case 5:x=3
break
case 4:u=$.ch().a
i=i?null:j.a
...
q=A.M(q,"DATE",n)
n=h.gkb()
q=A.M(q,"TREATMENTS",n)
n=h.b
h=h.c
h=A.bJA($.L().x.td($.aI),!0,r,!1,!0,p,t,q,new A.lV(n,h))
h.y=A.H([o.a,o],y.w,y.f)}else h=t.a.gbRJ()
x=6
return A.c(F.Wq(i,f,s,h,k.e,u),$async$$0)
case 6:m=e
if(m!=null&&!0)k.f.$1(m)
case 3:l=$.d0()
i=k.c
...
i=j.Q
j=i==null?j.ok:i}l.HW(j,k.r)
return A.h(null,w)}})
return A.i($async$$0,w)},
$S:1}
B.bJC.prototype={
$0(){var x=this.a,w=x.d
if(w!=null){w.a.bk=null
w.D()}x=x.c
...
x(A.bb,[B.cHl,B.cHm,B.bJD,B.bJC])
x(A.A,[B.a3Q,B.a90])})()
A.aV(b.typeUniverse,JSON.parse('{"a3Q":{"A":[],"l":[]},"a90":{"A":[],"l":[]}}'))
var y={u:A.v("G<l>"),o:A.v("b2<hI>"),F:A.v("aw"),f:A.v("iw"),w:A.v("n"),D:A.v("P<ce>"),y:A.v("f0?")}};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_484",e:"endPart",h:b})})($__dart_deferred_initializers__,"IcrZtBo0D8Oglisz2VuZtKpLRLg=");