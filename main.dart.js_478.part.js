...
aKI(d){var x=0,w=A.j(y.f),v=this,u,t
...
v=F.qk(s,w>1,s,s,d,s,s,s,A.d("clientRemindersExplanation",!0),!1,s,32,v)
w=A.fw(!1,s,!0,!1,!1,!0,!1,14,A.d("bookingsWillUpdatedFromNowOn",!0))
u=$.by().ay
t=u.h(0,"reminder")
t.toString
t=D.awC("alertToCustomersAboutComing","alertBookingTemplate",new B.bcB(x),new B.bcC(d),C.cr,!0,t,C.bi,"reminderShowcase")
u=u.h(0,"approvalArrivalReminder")
u.toString
return A.dF(v,s,A.hq(A.a([new A.m(s,24,s,s),w,t,D.awC("needConfirmationTitle","needConfirmBookingMessageFormat",new B.bcD(d),s,C.d9,!1,u,C.c8,"approvalArrivalReminderShowcase"),new A.m(s,30,s,s)],y.e),C.b_,s,x,!1),s,s,!1,s,s,23,!1,!1,x,!0)},
$S:102}
B.bcB.prototype={
...
x=2
return A.c(u.ho(C.b.gR(u.f).gbz(),C.Q,A.Y(0,0,0,200,0,0)),$async$$0)
