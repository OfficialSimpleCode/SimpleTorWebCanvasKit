...
$__dart_deferred_initializers__.current=function(a,b,c,$){var A,C,B={Zs:function Zs(d,e,f){this.c=d
this.d=e
this.a=f},blz:function blz(d){this.a=d},bly:function bly(d,e){this.a=d
this.b=e},blD:function blD(d){this.a=d},blC:function blC(d){this.a=d},blA:function blA(){},blB:function blB(){}},D
A=c[0]
C=c[2]
...
var z=a.updateTypes([])
B.blz.prototype={
$3(d,e,f){var x,w,v=null,u=$.cX,t=$.ff().d,s=!(!t.a.a||$.aJ==="")?A.q(d).ax.r:A.q(d).ax.cx
t=!(!t.a.a||$.aJ==="")?A.q(d).ax.f:C.z
x=this.a
w=x.d
if(w==null)w=new A.x(12,12,12,0)
return A.c1(!1,t,s,D.aPN,!0,!1,C.w,w,v,!0,new B.bly(x,d),!1,new A.x(4,4,4,4),u,v,v,24,v,v)},
$S:1300}
B.bly.prototype={
...
x(B.Zs,A.y)
w(A.b_,[B.blz,B.blD,B.blB])
w(A.b2,[B.bly,B.blC,B.blA])})()
